...
/**
 * 4층 관리부 주문 관리 컴포넌트
 * 전화, 팩스, 메일 등으로 요청이 오는 주문 처리
 */
const Floor4OrderManagement = () => {
			...
			<Modal
				...
				<div className="qr-code-container">
					...
					<div className="qr-order-info">
						...
						<p className="qr-method">
							{form.getFieldValue("orderMethod")} 주문
						</p>
					</div>
				</div>
			</Modal>
					...
					<div className="form-section">
						<Card
							...
							<Form.Item
								...
								label="주문 방법"
								rules={[
									{ required: true, message: "주문 방법을 선택해주세요" },
								]}>
								<Radio.Group>
									<Radio.Button value="전화">
										<PhoneOutlined /> 전화
									</Radio.Button>
									<Radio.Button value="팩스">
										<PrinterOutlined /> 팩스
									</Radio.Button>
									<Radio.Button value="이메일">
										<MailOutlined /> 이메일
									</Radio.Button>
								</Radio.Group>
							</Form.Item>
	...
	return (
		<div className="floor-order-management">
			<div className="page-header">
				<h1 className="page-title">4층 관리부 주문 관리</h1>
				<div className="header-subtitle">전화, 팩스, 이메일 주문 처리</div>
			</div>
...
export default Floor4OrderManagement;
